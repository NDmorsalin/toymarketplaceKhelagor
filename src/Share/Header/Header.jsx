          ...
          <div className="navbar-end gap-2 sm:gap-4">
            {user ? (
                  ...
                  >
                    <li>
                      <NavLink
                        to="/me"
                        className={({ isActive }) =>
                          `${isActive ? ' px-2 font-bold text-white bg-blue-500 hover:bg-blue-700 rounded-md' : ""} justify-between`
                        }
                      >
                        Profile
                    ...
                    <li>
                      <NavLink
                        className={({ isActive }) =>
                          isActive ? ' px-2 font-bold text-white bg-blue-500 hover:bg-blue-700 rounded-md' : ""
                        }
                        to="/settings"
                      >
                        Settings
              ...
              <>
                <NavLink
                  className={({ isActive }) =>
                    isActive ? ' font-bold text-white bg-blue-500 hover:bg-blue-700 rounded-md py-2 px-4' : ""
                  }
                  to="/auth/login"
                >
                  Login
                ...
                <NavLink
                  className={({ isActive }) =>
                    isActive ? 'py-2 px-4 font-bold text-white bg-blue-500 hover:bg-blue-700 rounded-md' : ""
                  }
                  to="/auth/register"
                >
                  Register
